    ...
    <!-- jQuery -->
    <script src="<?php echo base_url() ?>assets/user/assets/js/jquery-2.1.0.min.js"></script>
    ...
    <!-- Plugins -->
    <script src="<?php echo base_url() ?>assets/user/assets/js/scrollreveal.min.js"></script>
    ...
    <script src="<?php echo base_url() ?>assets/user/assets/js/imgfix.min.js"></script> 
