                            ...
                            <div class="card-body">
                                ...
                                <form method="post" id="import_form" enctype="multipart/form-data" action="<?php echo base_url('admin/excel_import/import') ?>">
                                    ...
                                    <div style="float: left; margin-left: 115px;">                               
                                        <a href="<?php echo base_url() ?>admin/datacleaning" class="btn btn-primary" type="submit" name=""  value=""><span class="fa fa-hourglass-half" style="float: left;"> Data Cleaning</span></a>
                                    </div>
